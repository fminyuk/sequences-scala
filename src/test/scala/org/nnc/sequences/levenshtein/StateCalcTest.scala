...
class StateCalcTest extends FunSuite {
  ...
  test("next n=1") {
    ...
    assert(s010.positions.length == 1)
    assert(s000.positions.length == 2)
    assert(s001.positions.length == 3)
    assert(s000 == s100)
    assert(s001 == s101)
    assert(s010 == s011)
    assert(s010 == s110)
    ...
    assert(s000n000.positions.length == 0)
    assert(s000n001.positions.length == 0)
    assert(s000n010.positions.length == 1)
    assert(s000n011.positions.length == 1)
    assert(s000n100.positions.length == 1)
    assert(s000n101.positions.length == 1)
    assert(s000n110.positions.length == 2)
    assert(s000n111.positions.length == 2)
    ...
    assert(s001n000.positions.length == 0)
    assert(s001n001.positions.length == 1)
    assert(s001n010.positions.length == 1)
    assert(s001n011.positions.length == 2)
    assert(s001n100.positions.length == 1)
    assert(s001n101.positions.length == 2)
    assert(s001n110.positions.length == 2)
    assert(s001n111.positions.length == 3)
    ...
    assert(s100n000.positions.length == 0)
    assert(s100n001.positions.length == 0)
    assert(s100n010.positions.length == 1)
    assert(s100n011.positions.length == 1)
    assert(s100n100.positions.length == 1)
    assert(s100n101.positions.length == 1)
    assert(s100n110.positions.length == 2)
    assert(s100n111.positions.length == 2)
  }
